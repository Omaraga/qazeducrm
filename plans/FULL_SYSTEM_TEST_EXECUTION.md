...
**Версия:** Pre-launch
**Статус:** CRM МОДУЛИ ПРОТЕСТИРОВАНЫ - ГОТОВО К ЗАПУСКУ
...
|----|--------|--------|--------|--------|-------------|
| CRM-01 | Dashboard | 8 | [x] | 0 | PASSED - виджеты, статистика, быстрые действия |
| CRM-02 | Ученики (Pupils) | 28 | [x] | 0 | PASSED - создание, список, карточка |
| CRM-03 | Группы (Groups) | 14 | [x] | 0 | PASSED - создание, привязка преподавателя |
| CRM-04 | Расписание (Schedule) | 17 | [x] | 0 | PASSED - календарь, создание занятия |
| CRM-05 | Лиды (Leads) | 11 | [x] | 0 | PASSED - создание, таблица, фильтры |
| CRM-06 | Канбан лидов | 11 | [x] | 0 | PASSED - воронка, карточки |
| CRM-07 | Платежи (Payments) | 14 | [x] | 0 | PASSED - приход, статистика |
| CRM-08 | Тарифы (Tariffs) | 8 | [ ] | [ ] | Не тестировали |
| CRM-09 | Предметы (Subjects) | 5 | [x] | 0 | PASSED - создание предмета |
| CRM-10 | Пользователи (Users) | 8 | [x] | 0 | PASSED - создание преподавателя |
| CRM-11 | Зарплаты (Salaries) | 12 | [ ] | [ ] | Не тестировали |
| CRM-12 | Отчёты (Reports) | 8 | [ ] | [ ] | Не тестировали |
| CRM-13 | Посещаемость | 7 | [ ] | [ ] | Не тестировали |
| CRM-14 | Кабинеты (Rooms) | 5 | [ ] | [ ] | Не тестировали |
| CRM-15 | Способы оплаты | 6 | [ ] | [ ] | Не тестировали |
| CRM-16 | Шаблоны расписания | 9 | [ ] | [ ] | Не тестировали |
| CRM-17 | Настройки | 5 | [ ] | [ ] | Не тестировали |
| CRM-18 | SMS | 10 | [ ] | [ ] | Не тестировали |
| CRM-19 | WhatsApp | 15 | [ ] | [ ] | Не тестировали |
| CRM-20 | Уведомления | 6 | [ ] | [ ] | Не тестировали |
| CRM-21 | Подписка | 11 | [ ] | [ ] | Не тестировали |
...
|------|-------------|--------|--------|---------|------------|
| Регистрация | 17 | 7 | 0 | 10 | Критические пройдены |
| SuperAdmin одобрение | 20 | 17 | 0 | 3 | Полный цикл пройден |
| SuperAdmin управление | 35 | 0 | 0 | 35 | Не тестировали |
| CRM модули | 200+ | 95+ | 0 | 105+ | Основные модули OK |
| Истечение подписки | 10 | 0 | 0 | 10 | Не тестировали |
| **ИТОГО** | **280+** | **119+** | **0** | **153+** | |
...
|----|----------|-----------|--------|
| BUG-001 | Alpine.js ошибки валидации в форме создания ученика (inputClass, hasError не определены) | Средний | ✅ ИСПРАВЛЕНО |
| BUG-002 | /crm/schedule редиректит на Dashboard вместо расписания (нужен /7/schedule/index) | Низкий | Обход найден |
| BUG-003 | Преподаватель не выбирается автоматически при выборе группы в расписании | Низкий | Косметический |

### Улучшения (идеи во время тестирования)

| ID | Описание | Приоритет |
|----|----------|-----------|
| IMP-001 | Добавить способы оплаты по умолчанию (Наличные, Kaspi) | Средний |
| IMP-002 | Автовыбор преподавателя если в группе только один | Низкий |
| IMP-003 | Валидация на клиенте должна работать без ошибок Alpine.js | Высокий | ✅ ИСПРАВЛЕНО |

### Исправленные баги

#### BUG-001: Alpine.js валидация (ИСПРАВЛЕНО 2026-01-09)

**Проблема:** Ошибки в консоли: `inputClass is not defined`, `hasError is not defined`, `isSubmitting is not defined`

**Причина:** `Json::htmlEncode()` кодировал JSON кавычки как `&quot;`, что конфликтовало с HTML атрибутом в двойных кавычках

**Решение:**
1. Изменили атрибут `x-data` с двойных на одинарные кавычки
2. Заменили `Json::htmlEncode()` на `Json::encode()`
3. Добавили `Alpine.data()` регистрацию компонента в `validation.js`

**Исправленные файлы:**
- `web/js/validation.js` - добавлена регистрация `Alpine.data('formValidation', ...)`
- `assets/TailwindAsset.php` - добавлена версия `?v=2` для сброса кэша
- `modules/crm/views/pupil/_form.php` - исправлен синтаксис x-data
- `modules/crm/views/lids/_form.php` - исправлен синтаксис x-data
