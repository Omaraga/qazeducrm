...
/**
 * Alert Widget - отображает flash сообщения
 *
 * Использование:
 *   <?= Alert::widget() ?>
 */
...
{
    /**
     * @var array типы алертов и их CSS классы
     */
    public $alertTypes = [
        'error'   => 'alert-danger',
        'danger'  => 'alert-danger',
    ...
    /**
     * @var array иконки для типов алертов
     */
    public $alertIcons = [
    ...
    protected function renderAlert($type, $message)
    {
        ...
        if ($this->closeButton) {
            $closeButton = <<<HTML
<button type="button" onclick="this.parentElement.remove()" class="ml-auto -mx-1.5 -my-1.5 p-1.5 rounded-lg hover:bg-black/10 focus:ring-2 inline-flex">
