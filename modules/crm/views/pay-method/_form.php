...
<form action="" method="post" class="max-w-2xl">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-lg font-semibold text-gray-900">Данные метода оплаты</h3>
        </div>
        <div class="card-body space-y-4">
            <div>
                <label class="form-label" for="paymethod-name">
                ...
                <?= Html::activeTextInput($model, 'name', [
                    ...
                    'id' => 'paymethod-name',
                    'maxlength' => true,
                    'placeholder' => 'Например: Наличные, Kaspi, Банковский перевод',
                    'autofocus' => true
                ]) ?>
        ...
        <div class="card-footer flex items-center gap-3">
            ...
            <a href="<?= OrganizationUrl::to(['pay-method/index']) ?>" class="btn btn-secondary">
                Отмена
            </a>
        </div>
    </div>
