...
$this->title = 'Редактировать лид: ' . $model->fio;
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">Измените данные лида</p>
        </div>
        <div>
            <a href="<?= OrganizationUrl::to(['lids/view', 'id' => $model->id]) ?>" class="btn btn-secondary">
