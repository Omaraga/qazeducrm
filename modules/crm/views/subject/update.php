...
$this->title = Yii::t('main', 'Редактировать предмет: {name}', ['name' => $model->name]);
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">Измените данные предмета</p>
        </div>
        <div>
            <a href="<?= OrganizationUrl::to(['subject/view', 'id' => $model->id]) ?>" class="btn btn-secondary">
