...
$canEdit = RoleChecker::canEditPayments();
$canDelete = RoleChecker::canDeletePayments();
$needsEditRequest = RoleChecker::needsPaymentChangeRequest();
$needsDeleteRequest = RoleChecker::needsPaymentDeleteRequest();
