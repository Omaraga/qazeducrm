...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 mt-1">Управление шаблонами сообщений</p>
        </div>
    ...
    <div class="border-b border-gray-200">
        <nav class="-mb-px flex gap-4">
            ...
            <a href="<?= OrganizationUrl::to(['sms/templates', 'type' => 'whatsapp']) ?>"
               class="py-2 px-1 border-b-2 text-sm font-medium flex items-center gap-1 <?= $type === 'whatsapp' ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' ?>">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Содержимое</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-20">Активен</th>
