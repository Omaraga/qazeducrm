...
jQuery(document).ready(function($){
    ...
    function Calendar(element, Args) {
        ...
        this.conf = {
            ...
            showNavigateButton: (Args.showNavigateButton !== undefined)? Args.showNavigateButton : true
        };
    ...
    Calendar.prototype.weekDrawDays = function() {
        ...
        for (var i=0; i<days.length; i++){
            ...
            if (i == 0 && this.mobileQuery() == 'desktop' && this.conf.showNavigateButton){
                div.append($('<button>', {
            ...
            if (i == days.length - 1 && this.mobileQuery() == 'desktop' && this.conf.showNavigateButton){
                div.append($('<button>', {
                    class: 'btn btn-sm btn-light btn-move-calendar'
    ...
    Calendar.prototype.monthDrawWeek = function() {
        ...
        if (this.mobileQuery() == 'desktop' && this.conf.showNavigateButton){
            div.append($('<button>', {
                    class: 'btn btn-sm btn-light btn-move-calendar'
                })
        ...
        for (i=0; i<n; i++){
            ...
            if (day === false){
                ...
                this.drawEventsOrDaynotes(
                    ...
                    e.content,
                    e.category,
                    e.color ? e.color : this.getEventCategoryColor(e.category),
        ...
        for (i=0; i<n; i++){
            ...
            if (day === false){
                ...
                this.drawEventsOrDaynotes(
                    ...
                    e.content,
                    e.category,
                    e.color ? e.color: this.getDaynoteCategoryColor(e.category),
                    '',
    ...
    Calendar.prototype.drawEventsOrDaynotes = function(e, index, start, end, title, content, category, color, time_interval, classes, url = null) {
